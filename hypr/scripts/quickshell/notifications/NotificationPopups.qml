        ...
        ListView {
            ...
            Keys.onPressed: event => {
                if (event.key === Qt.Key_PageUp) {
                    popupList.currentIndex = Math.max(0, popupList.currentIndex - Math.max(1, Math.floor(popupList.height / 80)));
                    event.accepted = true;
                } else if (event.key === Qt.Key_PageDown) {
                    popupList.currentIndex = Math.min(popupList.count - 1, popupList.currentIndex + Math.max(1, Math.floor(popupList.height / 80)));
                    event.accepted = true;
                }
            }
            ...
            ScrollBar.vertical: ScrollBar {
                ...
                contentItem: Rectangle {
                    implicitWidth: 4 * popupWindow.uiScale
                    radius: 2 * popupWindow.uiScale
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    color: _theme.base
                    border.color: _theme.surface1 || "#45475a"
                    border.width: 1
                    clip: true
