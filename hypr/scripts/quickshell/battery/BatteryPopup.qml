...
Item {
    ...
    Process {
        ...
        command: ["bash", "-c", 
            ...
            "ddcutil getvcp 10 2>/dev/null | grep -oP 'current value\s*=\s*\K[0-9]+' || echo '0'"
        ]
        running: true
        stdout: StdioCollector {
            onStreamFinished: {
                ...
                if (lines.length >= 5) {
                    ...
                    if (!window.isDraggingBri && !window.briCooldown) {
                        window.sysBrightness = parseInt(lines[0]) || 0;
    ...
    // Cooldown after manual brightness change to avoid poller overwriting before hardware reports back
    property bool briCooldown: false
    Timer { id: briCooldownTimer; interval: 1500; running: false; repeat: false; onTriggered: window.briCooldown = false }
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                            onClicked: { 
                                // Show confirmation dialog instead of immediate exit
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            anchors.centerIn: parent
                            spacing: window.s(16)
                            Rectangle { width: 1; height: 1; color: "transparent" } // placeholder to keep layout stable

                            Text {
                                text: "Sign Out?"
                                font.family: "JetBrains Mono"; font.pixelSize: window.s(20); font.weight: Font.Black
                                color: window.text
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    radius: window.s(10)
                                    width: window.s(100); height: window.s(40)
                                    color: logoutConfirmMa.containsMouse ? Qt.rgba(window.red.r, window.red.g, window.red.b, 0.2) : "transparent"
                                    ...
                                    MouseArea {
                                        ...
                                        anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                        onClicked: {
                                            confirmLogoutDialog.visible = false;
                                            exitAnim.start();
                                ...
                                Rectangle {
                                    radius: window.s(10)
                                    width: window.s(100); height: window.s(40)
                                    color: cancelConfirmMa.containsMouse ? Qt.rgba(window.surface1.r, window.surface1.g, window.surface1.b, 0.6) : "transparent"
                                    border.color: window.subtext0
                                    border.width: 1
                                    ...
                                    Item {
                                        ...
                                        MouseArea {
                                            ...
                                            onReleased: { 
                                                ...
                                                window.briCooldown = true;
                                                briCooldownTimer.restart();
                                            }
