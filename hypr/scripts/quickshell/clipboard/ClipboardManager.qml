...
Item {
    ...
    function deleteClipboardItem(id) {
        ...
        if (window.allClips.length > 0) {
            window.allClips = window.allClips.filter(item => item.id !== id);
        }
        window.filterClips(searchInput.text);
    }
            ...
            RowLayout {
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: window.clearAllClips()
                    }
                }
            }
        }
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        height: window.s(28)
                        radius: window.s(14)
                        color: delMa.containsMouse ? Qt.rgba(window.red.r, window.red.g, window.red.b, 0.2) : "transparent"
                        border.color: delMa.containsMouse ? window.red : "transparent"
                        border.width: 1
                    ...
                    MouseArea {
                        id: itemMouse
                        anchors.fill: parent
                        anchors.rightMargin: delBtn.width
